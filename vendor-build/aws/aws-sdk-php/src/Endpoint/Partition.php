...
use ArrayAccess;
use ExpressionEngine\Dependency\Aws\HasDataTrait;
use ExpressionEngine\Dependency\Aws\Sts\RegionalEndpoints\ConfigurationProvider;
use ExpressionEngine\Dependency\Aws\S3\RegionalEndpoint\ConfigurationProvider as S3ConfigurationProvider;
