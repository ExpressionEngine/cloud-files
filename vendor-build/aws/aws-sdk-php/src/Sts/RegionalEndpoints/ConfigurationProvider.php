...
namespace ExpressionEngine\Dependency\Aws\Sts\RegionalEndpoints;
...
use ExpressionEngine\Dependency\Aws\Sts\RegionalEndpoints\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            $data = \ExpressionEngine\Dependency\Aws\parse_ini_file($filename, \true);
            if ($data === \false) {
