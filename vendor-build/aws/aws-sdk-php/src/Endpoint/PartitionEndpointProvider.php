...
namespace ExpressionEngine\Dependency\Aws\Endpoint;

use ExpressionEngine\Dependency\JmesPath\Env;
class PartitionEndpointProvider
{
    ...
    {
        $data = \ExpressionEngine\Dependency\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \ExpressionEngine\Dependency\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
