...
use ExpressionEngine\Dependency\PhpParser\Comment\Doc as DocComment;
use ExpressionEngine\Dependency\PhpParser\Node;
use ExpressionEngine\Dependency\PhpParser\Node\Expr;
use ExpressionEngine\Dependency\PhpParser\Node\Name;
use ExpressionEngine\Dependency\PhpParser\Node\Stmt;
use ExpressionEngine\Dependency\PhpParser\Node\Stmt\Class_;
use ExpressionEngine\Dependency\PhpParser\PrettyPrinter\Standard;
use ExpressionEngine\Dependency\PhpParser\PrettyPrinterAbstract;
