...
use ExpressionEngine\Dependency\Aws\LruArrayCache;
...
use ExpressionEngine\Dependency\GuzzleHttp\Psr7\Stream;
use ExpressionEngine\Dependency\GuzzleHttp\Psr7\CachingStream;
...
class StreamWrapper
{
    ...
    public function dir_opendir($path, $options)
    {
        ...
        $this->objectIterator = \ExpressionEngine\Dependency\Aws\flatmap($this->getClient()->getPaginator('ListObjects', $op), function (Result $result) use($filterFn) {
