...
use ExpressionEngine\Dependency\Aws\Signature\SignatureV4;
...
class PresignUrlMiddleware
{
    ...
    private function createPresignedUrl(AwsClientInterface $client, CommandInterface $cmd)
    {
        ...
        $request = \ExpressionEngine\Dependency\Aws\serialize($newCmd);
        // Create the new endpoint for the target endpoint.
        if ($this->endpointProvider instanceof \ExpressionEngine\Dependency\Aws\EndpointV2\EndpointProviderV2) {
