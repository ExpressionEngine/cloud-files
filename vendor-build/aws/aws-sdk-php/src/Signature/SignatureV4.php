...
use ExpressionEngine\Dependency\AWS\CRT\Auth\Signable;
use ExpressionEngine\Dependency\AWS\CRT\Auth\SignatureType;
use ExpressionEngine\Dependency\AWS\CRT\Auth\SignedBodyHeaderType;
use ExpressionEngine\Dependency\AWS\CRT\Auth\Signing;
use ExpressionEngine\Dependency\AWS\CRT\Auth\SigningAlgorithm;
use ExpressionEngine\Dependency\AWS\CRT\Auth\SigningConfigAWS;
use ExpressionEngine\Dependency\AWS\CRT\Auth\StaticCredentialsProvider;
use ExpressionEngine\Dependency\AWS\CRT\HTTP\Request;
use ExpressionEngine\Dependency\Aws\Exception\CommonRuntimeException;
use ExpressionEngine\Dependency\Aws\Exception\CouldNotCreateChecksumException;
