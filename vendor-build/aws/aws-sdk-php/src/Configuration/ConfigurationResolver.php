...
namespace ExpressionEngine\Dependency\Aws\Configuration;
...
class ConfigurationResolver
{
    ...
    {
        if ($type === 'bool' && !is_null($convertedValue = \ExpressionEngine\Dependency\Aws\boolean_value($value))) {
    ...
    private static function retrieveValueFromIniSubsection($data, $profile, $filename, $expectedType, $options)
    {
        ...
        $services_section = \ExpressionEngine\Dependency\Aws\parse_ini_section_with_subsections($filename, "services {$data[$profile]['services']}");
