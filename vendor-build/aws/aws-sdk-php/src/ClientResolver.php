...
class ClientResolver
{
    ...
    public static function _apply_user_agent($inputUserAgent, array &$args, HandlerList $list)
    {
        ...
        if (\defined('ExpressionEngine\\Dependency\\HHVM_VERSION')) {
        ...
        if (isset($args['endpoint_discovery'])) {
            if ($args['endpoint_discovery'] instanceof \ExpressionEngine\Dependency\Aws\EndpointDiscovery\Configuration && $args['endpoint_discovery']->isEnabled()) {
        ...
        if (isset($args['retries'])) {
            if ($args['retries'] instanceof \ExpressionEngine\Dependency\Aws\Retry\Configuration) {
