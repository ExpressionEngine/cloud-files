...
namespace ExpressionEngine\Dependency\Aws\Multipart;

use ExpressionEngine\Dependency\Aws\AwsClientInterface as Client;
use ExpressionEngine\Dependency\Aws\CommandInterface;
use ExpressionEngine\Dependency\Aws\CommandPool;
use ExpressionEngine\Dependency\Aws\Exception\AwsException;
use ExpressionEngine\Dependency\Aws\Exception\MultipartUploadException;
...
abstract class AbstractUploadManager implements Promise\PromisorInterface
{
    ...
    private static $defaultConfig = ['part_size' => null, 'state' => null, 'concurrency' => self::DEFAULT_CONCURRENCY, 'prepare_data_source' => null, 'before_initiate' => null, 'before_upload' => null, 'before_complete' => null, 'exception_class' => 'ExpressionEngine\\Dependency\\Aws\\Exception\\MultipartUploadException'];
