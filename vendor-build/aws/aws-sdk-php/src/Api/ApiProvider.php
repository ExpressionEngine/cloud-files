...
use ExpressionEngine\Dependency\Aws\Exception\UnresolvedApiException;
/**
 * API providers.
 *
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \ExpressionEngine\Dependency\Aws\manifest());
    }
    /**
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \ExpressionEngine\Dependency\Aws\load_compiled_json($path);
