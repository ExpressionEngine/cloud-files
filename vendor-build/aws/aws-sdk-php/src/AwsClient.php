...
use ExpressionEngine\Dependency\Aws\ClientSideMonitoring\ConfigurationProvider;
use ExpressionEngine\Dependency\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
...
class AwsClient implements AwsClientInterface
{
    ...
    private function parseClass()
    {
        ...
        if ($klass === __CLASS__) {
            return ['', 'ExpressionEngine\\Dependency\\Aws\\Exception\\AwsException'];
        }
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \ExpressionEngine\Dependency\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \ExpressionEngine\Dependency\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
