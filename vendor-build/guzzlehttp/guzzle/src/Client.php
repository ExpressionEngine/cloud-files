...
use ExpressionEngine\Dependency\GuzzleHttp\Cookie\CookieJar;
use ExpressionEngine\Dependency\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \ExpressionEngine\Dependency\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
